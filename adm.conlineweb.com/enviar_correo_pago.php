...
if (file_exists("hostpro_email_helper.php")) {
    include "hostpro_email_helper.php";
}
if (file_exists(__DIR__ . "/includes/pago_email_template.php")) {
    include __DIR__ . "/includes/pago_email_template.php";
}
...
function enviarCorreoPago($correo_destino, $asunto, $datos_pago, $session_url, $sistema = 'conlineweb', $nombre_cliente = 'Cliente') {
    ...
    // Si es HostPro y existe la función del helper, usar su template
