...
if ($TWILIO_ACCOUNT_SID === '' || $TWILIO_AUTH_TOKEN === '' || $TWILIO_FROM === '' || str_contains($TWILIO_AUTH_TOKEN, 'PEGAR_AQUI')) {
    json_fail(500, function_exists('cw_twilio_auth_error_hint')
        ? cw_twilio_auth_error_hint('Falta Auth Token válido')
        : 'Twilio no está configurado (TWILIO_ACCOUNT_SID/TWILIO_AUTH_TOKEN/TWILIO_FROM)');
}
