...
<!--script src="https://www.google.com/recaptcha/api.js?render=6LdebwElAAAAAA_eyNV8Lcpfxi1Wn8YH9PRitvFC"></script-->
<!--script src="https://www.google.com/recaptcha/enterprise.js?render=6Le0_zMmAAAAAEq0CWEvmRV2uq0RohB3G-hPCiW2"></script-->
...
<div class="container">
  <form method="post" action="iniciarSesion.php" id="ingreso">   
    <div class="row">
        <div class="vl">
      ...
      width="48" height="48"></span></a>
            ...
            <div class="col">
                <div class="principal-central">
                    ...
                    <input type="password" name="txpassword" placeholder="Contraseña" id="myInput"/><label>

                    <input type="checkbox" onclick="myFunction()" > Mostrar Contraseña  </label><br>

        			<div class="g-recaptcha" data-sitekey="6LdebwElAAAAAA_eyNV8Lcpfxi1Wn8YH9PRitvFC"></div>
		        	<br>

                    <center>
        <button class="input" type="button" id="enviar_btn">Ingresar</button>
        </center><br>
    </form>
</div></div></div>
...
<script>
    ...
    $("#enviar_btn").on('click',function(e){
        ...
        if(user.length == "" || pass == ""){
            ...
            Swal.fire({
                title:'Resuelva el captcha para continuar',
                icon:'warning'
            });
        }
        else{
            $.ajax({
                ...
                type:"POST",
                dataType:"json",
                data:{txusuario:user, txpassword:pass,response:res},
                success:function(data){
                    ...
                    if(data==""){
                        Swal.fire({
                            title:'No se pudo comprobar el captcha, intente nuevamente',
                            icon:'error'
                        });
                    }
                    if(data=="1"){
