...
<head>
    ...
    <title>Facturas - &Aacute;rea cliente</title>
  ...
  <h3><span style="color: #ffffff;"><i class="bi bi-stack"></i> Facturas</span></h3></div>  <br>
 ...
 $query=mysqli_query($conn, "SELECT * from enlaces WHERE id= $usrid");
 while($mostrar=mysqli_fetch_array($query)){
?>         
                   
<a href="<?php echo $mostrar['url'];?>"><div  style="width: 100%;  background-color: #ffffff; margin:
  0 auto; text-align: left; padding: 15px; padding-top: 15px;  border-radius: 5px;"><div class="facant">Ver facturas anteriores al 2021 </div> </div> </a>               
...
<div class="tab">
  <button class="tablinks" onclick="openCity(event, '2021' )">A&ntilde;o 2021</button>
  <button class="tablinks" onclick="openCity(event, '2022') "id="defaultOpen">A&ntilde;o 2022</button>
...
<div style="width: 100%; background-color: #ffffff; margin: 0 auto;
 ...
 $query=mysqli_query($conn, "SELECT * from facturas2021 WHERE id= $usrid ORDER BY `facturas2021`.`id_operacion` DESC");
 while($mostrar=mysqli_fetch_array($query)){
?> 
<br><div class="header">
...
<div id="2022" class="tabcontent">
 ...
 $query=mysqli_query($conn, "SELECT * from facturas2022 WHERE id= $usrid ORDER BY `facturas2022`.`id_operacion` DESC");
...
<br><div class="header">
 ...
 <?php if($mostrar['id']==null){
          echo ' 
            <center><span style="color: #000000;">Archivo no disponible ';
          }  ?>       
...
<th colspan = 3><span style="color: #003366;"><strong>Producto</span></th>
<th><center><span style="color: #000000;"> <strong><span style="color: #003366;">Cantidad</span></strong></span></center></th>
<th colspan = 0><strong><span style="color: #003366;">Valor $</span></strong></th>
</tr>
                          <!-- servicio 1 -->
<tr>
<th colspan = 3><span style="color: #000000;"><?php echo $mostrar['servicio1'];?></span></th>
<th><center><span style="color: #000000;"><?php echo $mostrar['cantidad1'];?></span></center></th>
<th><span style="color: #000000;"><?php echo $mostrar['valor1'];?></span></th>
</tr>
...
<tr>
<th colspan = 3><span style="color: #000000;"><?php echo $mostrar['servicio3'];?></span></th>
<th><center><span style="color: #000000;"><?php echo $mostrar['cantidad3'];?></span></center></th>
<th><span style="color: #000000;"><?php echo $mostrar['valor3'];?></span></th>
</tr>
...
<tr>
<th colspan = 3><span style="color: #000000;"><?php echo $mostrar['servicio4'];?></span></th>
<th><center><span style="color: #000000;"><?php echo $mostrar['cantidad4'];?></span></center></th>
<th><span style="color: #000000;"><?php echo $mostrar['valor4'];?></span></th>
</tr>
...
<tr>
<th colspan = 3><span style="color: #000000;"><?php echo $mostrar['servicio7'];?></span></th>
<th><center><span style="color: #000000;"><?php echo $mostrar['cantidad7'];?></span></center></th>
<th><span style="color: #000000;"><?php echo $mostrar['valor7'];?></span></th>
</tr>
...
<tr>
<th colspan = 3><span style="color: #000000;"><?php echo $mostrar['servicio8'];?></span></th>
<th><center><span style="color: #000000;"><?php echo $mostrar['cantidad8'];?></span></center></th>
<th><span style="color: #000000;"><?php echo $mostrar['valor8'];?></span></th>
</tr>
...
<tr>
<th colspan = 3><span style="color: #000000;"><?php echo $mostrar['servicio9'];?></span></th>
<th><center><span style="color: #000000;"><?php echo $mostrar['cantidad9'];?></span></center></th>
<th><span style="color: #000000;"><?php echo $mostrar['valor9'];?></span></th>
</tr>


<tr>
<th colspan = 3><span style="color: #000000;"></span></th>
<th><center><span style="color: #000000;"><strong>Subtotal</strong></span></center></th>
<th><span style="color: #000000;"><?php echo $mostrar['Subtotal'];?> </span>
...
<tr>
<th colspan = 3><span style="color: #000000;"></span></th>
<th><center><span style="color: #000000;"><strong>Comisión</strong></span></center></th>
<th><span style="color: #000000;"><?php echo $mostrar['comision'];?> </span>
...
<tr>
<th colspan = 3><span style="color: #000000;"></span></th>
<th><center><span style="color: #000000;"><strong> IVA</strong></span></center></th>
<th><span style="color: #000000;"><?php echo $mostrar['Impuestos IVA'];?> </span></th>
</tr>
...
<th colspan = 3><span style="color: #000000;"></span></th>
<th><center><span style="color: #000000;"><strong>Total</strong></span></center></th>
<th><span style="color: #000000;"><strong><?php echo $mostrar['total'];?></strong> </span></th>
</tr>

<tr>
<th colspan = 3></th>
<th><center><span style="color: #000000;"><strong>Pendiente</strong></span></center></th>
<th><span style="color: #c50909;"><?php echo $mostrar['pendiente'];?></span></td>
</tr>
<tr>
<th colspan = 3></th>
<th><center><span style="color: #000000;"><strong>Pagado</strong></span></center></th>
<th><span style="color: #12c509;"><?php echo $mostrar['ya_pagado'];?></span></th>
</tr>
</tbody>
</table><br>
...
<center><font size="2" style = "font-family:Calibri;"><span style="text-decoration-line: underline;"><a href="https://c-onlineweb.com/area-clientes/facturas/<?php echo $mostrar['url_factura'];?>" download><img src="https://conlineweb.com/wp-content/uploads/2020/10/factura.png" alt="" width="25" height="25" /><span style="color: #800000;">DESCARGAR RECIBO DE PAGO</a></span></span></font></center></a>
