...
from app.api.v1.endpoints import auth, dashboard, clientes, dominios, hostings, pagos, recordatorios, solicitudes, portal
...
api_router.include_router(portal.router, prefix="/portal", tags=["Portal de Clientes"])
